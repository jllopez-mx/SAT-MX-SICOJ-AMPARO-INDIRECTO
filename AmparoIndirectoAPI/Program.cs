#region Usings
using AmparoIndirectoAPI.ServiceRegistration;
...
builder.Services.AddOficialPartesServices();
builder.Services.AddAdministradorServices();
builder.Services.AddAbogadoServices();
builder.Services.AddAdministradorGlobalServices();
builder.Services.AddAdministradorUnidadAdministrativaServices();
#endregion
...
{
    option.SwaggerDoc("v1", new OpenApiInfo { Title = "Amparo Indirecto API", Version = "v1" });
