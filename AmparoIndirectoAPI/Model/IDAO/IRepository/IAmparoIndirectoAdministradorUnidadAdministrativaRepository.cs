...
{
    public interface IAmparoIndirectoAdministradorUnidadAdministrativaRepository
    {
        
        //Task<ResponseSuspensionProvisionalIncidental> GetAllSuspensionProvisionalIncidentalAsync(int id);
       

        Task<List<ResponseAmparoIndirectoAdministradorUnidadAdministrativaBandeja>> GetAllAdministradorUnidadAdministrativa(
            int pageSize,
            int page,
            string orderByColumn,
            bool orderDesc);

        Task<int?> GetAllAdministradorUnidadAdministrativaCount();
