...
{
    public class RequestHistoricoAdministradorFilters
    {
        public List<string> ByFechaRecepcionInicial { get; set; } = new()!;
        public List<string> ByFechaRecepcionFinal { get; set; } = new()!;
        public List<string> ByFechaVencimientoDemandaIncial { get; set; } = new()!;
        public List<string> ByFechVencimientoDemandaFinal { get; set; } = new()!;
