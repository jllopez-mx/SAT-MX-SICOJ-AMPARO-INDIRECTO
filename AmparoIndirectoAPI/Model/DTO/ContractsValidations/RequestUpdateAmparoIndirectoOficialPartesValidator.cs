...
{
    public class RequestUpdateAmparoIndirectoOficialPartesValidator : AbstractValidator<RequestUpdateAmparoIndirectoOficialPartes>
    {
        public RequestUpdateAmparoIndirectoOficialPartesValidator()
        {
            ...
            //RuleFor(c => c.numero_oficio_segunda_pieza)
            //   .NotNull()
            //   .NotEmpty()
            //   .WithMessage("Número de oficio de segunda pieza es requerido")
            //   .Must(ValidateOficio)
            //   .WithMessage("Número de oficio de segunda pieza no es válido");
