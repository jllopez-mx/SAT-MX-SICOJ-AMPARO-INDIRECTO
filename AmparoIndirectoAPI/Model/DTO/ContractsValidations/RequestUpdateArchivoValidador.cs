...
{
    public class RequestUpdateArchivoValidador : AbstractValidator<RequestUpdateDocumento>
    {
        public RequestUpdateArchivoValidador()
        {
            RuleFor(c => c.id_numero_asunto).NotNull().NotEmpty().WithMessage("Juicio de Amparo es requerido");
