...
{
    public class RequestAsignarAbogadoOficialPartesValidator : AbstractValidator<RequestAsignarAbogadoOficialPartes>
    {
        public RequestAsignarAbogadoOficialPartesValidator()
        {
            RuleFor(c => c.id)
                .NotNull()
                .NotEmpty()
