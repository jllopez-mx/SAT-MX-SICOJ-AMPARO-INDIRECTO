...
{
    public class AmparoIndirectoAdministradorRepository : IAmparoIndirectoAdministradorRepository
    {
        ...
        #region Constructor
        public AmparoIndirectoAdministradorRepository(ISqlTools database)
        {
        ...
        #region GetAll
        public async Task<int?> GetAllAdmCount()
        {
            ...
            var response = await _database.ExecuteFunctionAsync(
                EnumFunctions.BandejaAdmGetAllCount,
                parameters!
            );
        ...
        public async Task<List<ResponseAmparoIndirectoAdministradorBandeja>> GetAllAdm(
                int pageSize,
                int page,
            ...
            )
        {
            ...
            var response = await _database.ExecuteFunctionAsync(
                EnumFunctions.BandejaAdmGetAll,
                parameters!
            );
            if (response.ExisteError)
            {
            ...
            List<ResponseAmparoIndirectoAdministradorBandeja> resultList = new();
            foreach (DataRow item in response.Data.Tables[0].Rows)
            {
                resultList.Add(
                    new()
                    {
                        ...
                        rfc_quejoso = item.IsNull(17) ? null! : item.Field<string>(17)!,
                        id_estado_tarea= item.IsNull(18) ? 0 : item.Field<int>(18),
                        estado_tarea = item.IsNull(19) ? null! : item.Field<string>(19)!,
                        //id_estado_tarea = new()
                        //{
                        //    Value = item.IsNull(18) ? 0 : item.Field<int>(18),
                        //    Label = item.IsNull(19) ? null! : item.Field<string>(19)
                        //},
                        id_autoridad_responsable = item.IsNull(20) ? 0 : item.Field<int>(20),
                        autoridad_responsable = item.IsNull(21) ? null! : item.Field<string>(21)!,
                        //id_autoridad_responsable = new()
                        //{
                        //    Value = item.IsNull(20) ? 0 : item.Field<int>(20),
                        //    Label = item.IsNull(21) ? null! : item.Field<string>(21)
                        //},
                        id_estado_procesal= item.IsNull(22) ? 0 : item.Field<int>(22),
                        estado_procesal = item.IsNull(23) ? null! : item.Field<string>(23)!,
                        //id_estado_procesal = new()
                        //{
                        //    Value = item.IsNull(22) ? 0 : item.Field<int>(22),
                        //    Label = item.IsNull(23) ? null! : item.Field<string>(23)
                        //},
                        id_estado_procesal_incidental = item.IsNull(24) ? 0 : item.Field<int>(24),
                        estado_procesal_incidental = item.IsNull(25) ? null! : item.Field<string>(25)!,
                        //id_estado_procesal_incidental = new()
                        //{
                        //    Value = item.IsNull(24) ? 0 : item.Field<int>(24),
                        //    Label = item.IsNull(25) ? null! : item.Field<string>(25)
                        //},
                        activo = item.IsNull(26) ? false : item.Field<bool>(26),

                        //activo = response.Data.Tables[0].Rows[0].IsNull(24)
                        //? false
        ...
        #endregion
        #region Get Histórico ByFilters para Administrador
        public async Task<List<ResponseHistoricoAdministradorByFilters>> GetHistoricoByFilters(
                int Fetch,
                int Page,
                string OrderByColumn,
                bool OrderDesc,
            ...
            )
        {
            ParameterPGsql[] parameters =
            {
                ...
                new ParameterPGsql("p_fecha_vencimiento_demanda_inicial", NpgsqlDbType.Date, fechaVencimientoDemandaInicial),
                new ParameterPGsql("p_fecha_vencimiento_demanda_final", NpgsqlDbType.Date, fechaVencimientoDemandaFinal),
                ...
                new ParameterPGsql("p_id_autoridad_responsable", NpgsqlDbType.Integer, idAutoridadResponsable),
                new ParameterPGsql("p_rfc_quejoso", NpgsqlDbType.Varchar, rfcQuejoso),
                //new ParameterPGsql("p_id_estado_tarea", NpgsqlDbType.Integer, EnumEstadoTarea.TURNAR.GetHashCode()),
                new ParameterPGsql("p_id_estado_tarea", NpgsqlDbType.Integer, idEstadoTarea),
            ...
            var response = await _database.ExecuteFunctionAsync(
                EnumFunctions.HistoricoAdmByFilters,
                parameters!
            );
            if (response.ExisteError)
            {
            ...
            List<ResponseHistoricoAdministradorByFilters> resultList = new();
            foreach (DataRow item in response.Data.Tables[0].Rows)
            {
                resultList.Add(
                    new()
                    {
                        ...
                        id_alerta = item.IsNull(5) ? 0 : item.Field<int>(5),
                        alerta = item.IsNull(6) ? null! : item.Field<string>(6)!,
                        id_juzgado = item.IsNull(7) ? 0 : item.Field<int>(7),
                        juzgado = item.IsNull(8) ? null! : item.Field<string>(8)!,
                        ...
                        //},
                        id_subadministracion = item.IsNull(19) ? 0 : item.Field<int>(19),
                        subadministracion = item.IsNull(20) ? null! : item.Field<string>(20)!,
                        //id_subadministracion = new()
                        //{
                        //    Value = item.IsNull(19) ? 0 : item.Field<int>(19),
                        //    Label = item.IsNull(20) ? null! : item.Field<string>(20)
                        //},
                        id_autoridad_responsable = item.IsNull(21) ? 0 : item.Field<int>(21),
                        autoridad_responsable = item.IsNull(22) ? null! : item.Field<string>(22)!,
                        //id_autoridad_responsable = new()
                        //{
                        //    Value = item.IsNull(21) ? 0 : item.Field<int>(21),
                        //    Label = item.IsNull(22) ? null! : item.Field<string>(22)
                        //},
                        rfc_quejoso = item.IsNull(23) ? null! : item.Field<string>(23)!,
                        id_estado_tarea = item.IsNull(24) ? 0 : item.Field<int>(24),
                        estado_tarea = item.IsNull(25) ? null! : item.Field<string>(25)!,
                        //id_estado_tarea = new()
                        //{
                        //    Value = item.IsNull(24) ? 0 : item.Field<int>(24),
                        //    Label = item.IsNull(25) ? null! : item.Field<string>(25)
                        //},
                        id_estado_procesal = item.IsNull(26) ? 0 : item.Field<int>(26),
                        estado_procesal = item.IsNull(27) ? null! : item.Field<string>(27)!,
                        //id_estado_procesal = new()
                        //{
                        //    Value = item.IsNull(26) ? 0 : item.Field<int>(26),
                        //    Label = item.IsNull(27) ? null! : item.Field<string>(27)
                        //},
                        id_estado_procesal_incidental = item.IsNull(28) ? 0 : item.Field<int>(28),
                        estado_procesal_incidental = item.IsNull(29) ? null! : item.Field<string>(29)!,
                        //id_estado_procesal_incidental = new()
                        //{
                        //    Value = item.IsNull(28) ? 0 : item.Field<int>(28),
                        //    Label = item.IsNull(29) ? null! : item.Field<string>(29)
                        //},
        ...
        public async Task<int?> GetHistoricoByFiltersCount(
        DateTime? fechaRecepcionInicial,
        DateTime? fechaRecepcionFinal,
        DateTime? fechaVencimientoDemandaInicial,
        DateTime? fechaVencimientoDemandaFinal,
        ...
        )
        {
            ...
            var response = await _database.ExecuteFunctionAsync(
                EnumFunctions.HistoricoAdmByFiltersCount,
                parameters!
            );
            if (response.ExisteError)
            {
        ...
        public async Task<ResponseAmparoIndirectoByID> GetByIdAmparoAsync(int idNumeroAsunto)
        {
            ...
            return new()
            {
                ...
                //juzgado = response.Data.Tables[0].Rows[0].IsNull(5) ? null! : response.Data.Tables[0].Rows[0].Field<string>(5)!,
