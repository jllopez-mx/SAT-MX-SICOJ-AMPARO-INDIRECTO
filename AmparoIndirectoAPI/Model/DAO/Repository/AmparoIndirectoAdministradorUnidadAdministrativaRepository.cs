...
{
    public class AmparoIndirectoAdministradorUnidadAdministrativaRepository : IAmparoIndirectoAdministradorUnidadAdministrativaRepository
    {
        ...
        #region Constructor
        public AmparoIndirectoAdministradorUnidadAdministrativaRepository(ISqlTools database)
        {
        ...
        public async Task<int?> GetAllAdministradorUnidadAdministrativaCount()
        {
            ...
            var response = await _database.ExecuteFunctionAsync(
                EnumFunctions.BandejaAdministradorUnidadAdministrativaGetAllCount
            //,parameters!
            );
        ...
        public async Task<List<ResponseAmparoIndirectoAdministradorUnidadAdministrativaBandeja>> GetAllAdministradorUnidadAdministrativa(
                int pageSize,
                int page,
            ...
            )
        {
            ...
            var response = await _database.ExecuteFunctionAsync(
                EnumFunctions.BandejaAdministradorUnidadAdministrativaGetAll,
                parameters!
            );
            if (response.ExisteError)
            {
            ...
            List<ResponseAmparoIndirectoAdministradorUnidadAdministrativaBandeja> resultList = new();
            foreach (DataRow item in response.Data.Tables[0].Rows)
            {
                resultList.Add(
                    new()
                    {
                        ...
                        no_autoridades = item.IsNull(17) ? 0 : (int)item.Field<long>(17),
                        ...
                        //},
                        abogado = item.IsNull(22) ? null! : item.Field<string>(22),
